...
function ensureAdminFavicon() {
    var faviconHref = '../images/logo.jpg';
...
function ensureMisThemeToggleScript() {
    if (document.getElementById("rtThemeToggleScript")) return;
    var script = document.createElement("script");
    script.id = "rtThemeToggleScript";
