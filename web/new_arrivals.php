...
$totalProducts = 0;
$countQuery = mysqli_query($conn, "SELECT COUNT(*) AS total FROM tblproduct WHERE status='1'");
if ($countQuery) {
  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 ftco-animate text-center">
        <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>New Arrivals</span></p>
        <h1 class="mb-0 bread">New Arrivals</h1>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="col-lg-9">
        <div class="row g-4">
          <?php if (count($products) === 0): ?>
            <div class="col-12 text-center"><p class="mb-0">No new products available.</p></div>
          <?php endif; ?>
