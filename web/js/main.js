...
// category carousel — only runs if elements exist on this page
...
if (container && next && prev) {
	const getItems = () => container.querySelectorAll('.category-item');
	if (getItems().length > 1) {
		...
		function getStepWidth() {
			const first = container.querySelector('.category-item');
			if (!first) return 0;
